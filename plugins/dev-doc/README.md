...
Plugin, A methodology for maintaining project context across Claude Code sessions and context resets.
...
1. **Use /dev-doc-create slash command:**
   ```
   /dev-doc-create refactor authentication system
   ```
...
**Usage:**
```
/dev-doc-create implement real-time notifications
```
...
1. **Use the /dev-doc-create slash command** if available
...
If you don't have the /dev-doc-create command:
